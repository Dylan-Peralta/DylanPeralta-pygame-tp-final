    ...
    while True:
        ...
        if button_back.collidepoint((mx, my)):
            if pg.mouse.get_pressed()[0]:
                return  # Volver al menú principal al presionar el botón "Volver"
        ...
        texto_menu('Volver', pg.font.Font(None, 36), BLACK, PANTALLA, 860, 460)
            ...
            # Botones para activar/desactivar música y efectos de sonido
        ...
        if button_music.collidepoint((mx, my)):
            if pg.mouse.get_pressed()[0]:
                music_enabled = not music_enabled  # Invertir el estado de la música
        ...
        if button_sound_effects.collidepoint((mx, my)):
            if pg.mouse.get_pressed()[0]:
                sound_effects_enabled = not sound_effects_enabled  # Invertir el estado de los efectos de sonido
