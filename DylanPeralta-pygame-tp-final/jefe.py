...
class Jefe:
    ...
    def __init__(self, coordenada_x, coordenada_y, velocidad = 5, vida_total = 300, gravedad = 1):
        self.__caminar_der = Auxiliar.obtener_superficie_desde_sprite('C:/Users/Dylan/Desktop/DylanPeralta-pygame-tp-final/elementos_juego/imagenes/Jefe/Jefe_uno.png', 8, 1, voltear=True)
        self.__caminar_izq = Auxiliar.obtener_superficie_desde_sprite('C:/Users/Dylan/Desktop/DylanPeralta-pygame-tp-final/elementos_juego/imagenes/Jefe/Jefe_uno.png', 8, 1, voltear=False)
